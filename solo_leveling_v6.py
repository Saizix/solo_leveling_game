...
donjons = st.session_state.get("donjons", {
    "Donjon du Dragon": {"niveau": 1, "xp": 100},
    "Caverne Maudite": {"niveau": 2, "xp": 200}
})
...
if menu == "🎒 Inventaire":
    ...
    if inventaire:
        ...
        st.write("Votre inventaire est vide.")
...
st.session_state["donjons"] = donjons
